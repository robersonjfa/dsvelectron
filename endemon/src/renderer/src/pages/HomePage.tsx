      ...
      {!loggedUser ? (
        <>
          ...
          <p className="font-bold text-center text-1xl md:text-1xl">
            ...
            intuitivo, usuários podem registrar e visualizar em tempo real a distribuição geográfica
            de focos de doenças. Esse mapeamento permite a rápida identificação de áreas críticas,
            facilitando ações preventivas e de controle. Com a tecnologia do Endemon, a comunidade e
            as autoridades sanitárias unem forças em uma frente comum contra as endemias, promovendo
            um ambiente mais seguro e saudável para todos.
          </p>
        </>
      ) : (
        <div></div>
